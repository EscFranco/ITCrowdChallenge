...
const Admin = () => {
    ...
    const deleteProduct = (id) => {
        ...
        .then((res) => res.json())
        .then((res => setProductos(res.item)))
    }
    ...
    return (
        <main>
            {productos.length !== 0 ? (
                <>
                    <h4 className="text-center p-5"> ADMINISTRACION</h4>
                    <TableItems productos={productos} deleteproduct={deleteProduct} updateitem={updateItem} />
